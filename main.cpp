...
struct Pracownik{
    Pracownik(string imie, string nazwisko, int stanowisko, int il_minut) :  imie(imie), nazwisko(nazwisko), id(-1), stanowisko(stanowisko), il_minut(il_minut){}
    string imie;
    string nazwisko;
    int id;
...
int main(){
    Pracownik p1("Antoni", "Skrzyniarz", 1, 0);
    Pracownik p2("Weronika", "Nagawiecka", 1, 450);
    Pracownik p3("Szymon", "Kuczek", 1, 605);
    Pracownik p4("Paulina", "Filimon", 1, 520);
    Pracownik p5("Julia", "Pietron", 2, 480);
    Pracownik p6("Aleksandra", "Sek", 2, 295);
    Pracownik p7("Aleksandra", "Guzy", 2, 300);
    Pracownik p8("Paulina", "Sokolowska", 2, 410);
    Pracownik p9("Julia", "Ciembka", 2, 380);
    Pracownik p10("Ignacy", "Skrzyniarz", 0, 390);
    Pracownik p11("Olga", "Wiecek", 0, 470);
    Pracownik p12("Iga", "Kozlowska", 0, 410);
    Pracownik p13("Zofia", "Watroba", 0, 450);
    Pracownik p14("Barbara", "Stojek", 0, 700);
    Pracownik p15("Dominika", "Piatek", 0, 540);
    Pracownik p16("Szczepan", "Lompe", 0, 290);
    Pracownik p17("Katarzyna", "Pikul", 0, 290);
    Pracownik p18("Laura", "Kamasz", 0, 370);
    Pracownik p19("Lilianna", "Noga", 0, 320);
    Pracownik p20("Celina", "Wojtanowska", 0, 370);
    Pracownik p21("Jakub", "Drewnicki", 0, 270);
    Pracownik p22("Julia", "Krawczyk", 0, 270);
    Pracownik p23("Maja", "Duszak", 0, 410);
    Pracownik p24("Patryk", "Kozlowski", 0, 350);
    Pracownik p25("Tosia", "Malecka", 0, 550);
    Pracownik p26("Zuzanna", "Adamowicz", 0, 280);
